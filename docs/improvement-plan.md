...
**Source**: [[acai-sh]] (article note), plus existing MAP philosophy and artifact-pipeline backlog context
...
**Missing Capability**: Stable acceptance-criteria IDs that connect specs, generated subtask contracts, tests, review findings, and verification summaries across the MAP artifact pipeline.
