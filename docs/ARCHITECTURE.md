...
- `.codex/`: Codex CLI provider surfaces generated by `mapify init . --provider codex`
- `.map/<branch>/`: Branch-scoped run artifacts (plans/contracts, check outputs, review notes, learning handoffs)
