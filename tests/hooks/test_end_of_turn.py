...
class TestProjectDetection:
    ...
    def test_detect_python_pyproject(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            exit_code, _, stderr = run_hook(cwd=tmpdir, env={"CLAUDE_HOOK_VERBOSE": "true"})
...
class TestEnvFileDetection:
    ...
    def test_env_local_staged(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert exit_code == 2, f"Should exit 2 for .env.local staged"
...
class TestVerboseMode:
    ...
    def test_quiet_by_default(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            exit_code, _, stderr = run_hook(cwd=tmpdir)
            assert "[end-of-turn]" not in stderr, "Should not have verbose logs by default"
