...
- **simplicity**: Prioritize the smallest sufficient safe change: stdlib/native/existing project patterns before new abstractions, with clarity over cleverness
